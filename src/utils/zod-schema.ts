...
export type SchemaPartial<T extends z.ZodTypeAny> = z.ZodType<
  Partial<z.infer<T>>
>;
export type PartialData<T extends z.ZodTypeAny> = z.infer<SchemaPartial<T>>;
export type SchemaWithId<T extends z.ZodTypeAny> = z.ZodType<
  z.infer<T> & { id: string }
>;
export type DataWithId<T extends z.ZodTypeAny> = z.infer<SchemaWithId<T>>;

export function addIdToSchema<T extends z.ZodTypeAny>(
  schema: T,
): SchemaWithId<T> {
